...
INSERT INTO codebase (id, type, name, language, framework, build_tool, strategy, repository_url, route_site, route_path, database_kind, database_version, database_capacity, database_storage, status, test_report_framework, description) VALUES (2, 'application', 'bar-service', 'java', 'springboot', 'maven', 'clone', 'https://git.epam.com/epmd-edp/examples/basic/bar-service.git', '', '', '', '', '', '', 'active', '', '');
INSERT INTO codebase (id, type, name, language, framework, build_tool, strategy, repository_url, route_site, route_path, database_kind, database_version, database_capacity, database_storage, status, test_report_framework, description) VALUES (1, 'application', 'foo-service', 'java', 'springboot', 'maven', 'clone', 'https://git.epam.com/epmd-edp/examples/basic/foo-service.git', '', '', '', '', '', '', 'active', '', '');
INSERT INTO codebase (id, type, name, language, framework, build_tool, strategy, repository_url, route_site, route_path, database_kind, database_version, database_capacity, database_storage, status, test_report_framework, description) VALUES (4, 'autotests', 'foobar-tests', 'java', null, 'maven', 'clone', 'https://git.epam.com/epmd-edp/examples/basic/foobar-tests.git', '', '', '', '', '', '', 'active', 'allure', 'foobar-tests');
INSERT INTO codebase (id, type, name, language, framework, build_tool, strategy, repository_url, route_site, route_path, database_kind, database_version, database_capacity, database_storage, status, test_report_framework, description) VALUES (3, 'application', 'zuul', 'java', 'springboot', 'maven', 'clone', 'https://git.epam.com/epmd-edp/examples/basic/zuul.git', 'zuul', '/', '', '', '', '', 'active', '', '');
